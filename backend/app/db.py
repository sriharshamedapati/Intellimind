...
if settings.SUPABASE_URL and settings.SUPABASE_KEY:
    try:
        ...
        print(f"[db] ✅ Data Supabase initialized: {settings.SUPABASE_URL}")
    except Exception as e:
        print(f"[db] ❌ Data Supabase failed: {e}")
...
if settings.AUTH_SUPABASE_URL and settings.AUTH_SUPABASE_KEY:
    try:
        ...
        print(f"[db] ✅ Auth Supabase initialized: {settings.AUTH_SUPABASE_URL}")
    except Exception as e:
        print(f"[db] ❌ Auth Supabase failed: {e}")
else:
